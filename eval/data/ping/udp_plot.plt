...
set x2range [ * : * ] noreverse nowriteback  # (currently [291.000:2643.00] )
...
GNUTERM = "aqua"
plot "cdf_udping.csv" with lp title "direct:udp", "cdf_udping_prison.csv" with lp title "prison:udp"
#    EOF
