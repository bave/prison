...
set angles radians
unset grid
set key title "" font "Helvetica, 20"
...
set xrange [ * : * ] noreverse nowriteback  # (currently [0.00000:3000.00] )
set x2range [ * : * ] noreverse nowriteback  # (currently [326.000:2546.00] )
...
set y2range [ * : * ] noreverse nowriteback  # (currently [1.00000:100.000] )
set zlabel "" 
...
GNUTERM = "aqua"
plot "cdf_tcping.csv" with lp title "direct:tcp", "cdf_tcping_prison.csv" with lp title "prison:tcp"
#    EOF
