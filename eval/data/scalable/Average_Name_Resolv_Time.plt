...
set y2range [ * : * ] noreverse nowriteback  # (currently [229.000:238.512] )
set zlabel "" 
...
GNUTERM = "aqua"
plot "graph.data" using 1:2:3 with yerrorbars title "Average Name Resolve Time", "graph.data" lc rgb "red" with line notitle
#    EOF
