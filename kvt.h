...
- (bool)_dequeueRequest:(NSString*)message
{
    ...
    if ([kvtRequestQueue member:string] != nil) {
        [kvtRequestQueue removeObject:string];
        return true;
    }
    return false;
}
...
- (bool)_enqueueRequest:(NSString*)message
{
    ...
    [kvtRequestQueue addObject:string];
    return true;
}
